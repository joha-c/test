...
#for divisoraprobar in range(2, int(numeroaprobar**0.5) + 1): Este bucle interno itera a través de todos los posibles divisores desde 2 hasta el resultado de la raiz cuadrada entera de numeroaprobar actual mas 1(Sumamos 1 para asegurarnos de incluir la raíz cuadrada en el rango si es un número entero). la convertimos a entero con int()
